...
(function (definition) {
	...
	CIQ.QuoteFeed.Xignite.prototype.fetch=function(params, cb){
		...
		if(api && args && error===""){
			...
			var mamaCallbackFunction=function(status, res){
				...
				function processData(quotes, params){
					...
					for(i=1;i<arr.length;i++){
						...
						if(api.results.message){
							...
							else if(fields[fieldNames[api.results.message]].indexOf("No match found")===0 ||
				...
				var isUpdate=(params.originalState && params.originalState.update) || (!params.originalState && params.update);
	...
	CIQ.QuoteFeed.Xignite.Templates={
		...
		HistoricalEquity: {
			...
			fields:	"Message,GlobalQuotes.Date,GlobalQuotes.Last,GlobalQuotes.Open,GlobalQuotes.High,GlobalQuotes.Low,GlobalQuotes.Volume,GlobalQuotes.SplitRatio",
			results:{
				message:"Message",
		...
		HistoricalOptions: {
		    ...
		    fields: "Message,ChartBars.StartDate,ChartBars.Open,ChartBars.Close,ChartBars.High,ChartBars.Low,ChartBars.Volume",
		    results: {
				message:"Message",
		...
		IntradayEquity: {
			...
			fields:	"Message,ChartBars.StartDate,ChartBars.StartTime,ChartBars.UTCOffset,ChartBars.Close,ChartBars.Open,ChartBars.High,ChartBars.Low,ChartBars.Volume,ChartBars.AdjustmentRatio",
			results:{
				message:"Message",
				date:	"ChartBars StartDate",
		...
		SuperIntradayEquity: {
			...
			method:	"GetChartBars",
			statics:"Precision=Minutes&AdjustmentMethod=None",
			fields:	"Message,ChartBars.StartDateTime,ChartBars.UTCOffset,ChartBars.Close,ChartBars.Open,ChartBars.High,ChartBars.Low,ChartBars.Volume,ChartBars.AdjustmentRatio",
			results:{
				message:"Message",
		...
		IntradayBATSRTEquity: {
			...
			method:	"GetChartBars",
			statics:"Precision=Minutes&AdjustmentMethod=None",
			fields:	"Message,ChartBars.StartDate,ChartBars.StartTime,ChartBars.UTCOffset,ChartBars.Close,ChartBars.Open,ChartBars.High,ChartBars.Low,ChartBars.Volume,ChartBars.AdjustmentRatio,Security.MarketIdentificationCode",
			results:{
				message:"Message",
				date:	"ChartBars StartDate",
				time:	"ChartBars StartTime",
		...
		IntradayIndex: {
			...
			method:	"GetChartBars",
			statics:"Precision=Minutes&AdjustmentMethod=None",
			fields:	"Message,ChartBars.StartDate,ChartBars.StartTime,ChartBars.UTCOffset,ChartBars.Close,ChartBars.Open,ChartBars.High,ChartBars.Low,ChartBars.Volume",
			results:{
				message:"Message",
				date:	"ChartBars StartDate",
				time:	"ChartBars StartTime",
		...
		IntradayRTForex: {
			...
			fields:	"Message,ChartBars.StartDate,ChartBars.StartTime,ChartBars.UTCOffset,ChartBars.Open,ChartBars.High,ChartBars.Low,ChartBars.Close,ChartBars.Volume",
			results:{
				message:"Message",
				date:	"ChartBars StartDate",
				time:	"ChartBars StartTime",
