export default {
  ...
  login_msg_1: 'Try a coin-related account on COCOBANK!',
  login_msg_2: 'Use transaction, wallet and sevices through COCOBANK.',
  login_msg_3: 'COCOBANK supports all environments.',
  cocofx_register: 'Join COCOBANK',
  register_msg_1:
  ...
  register_step1: 'Click COCOBANK Button',
  register_step2: 'Login to COCOBANK',
  ...
  ccf: {
    ...
    key_coin:
      'It’s key coin of COCOBANK which connects cryptocurrency to real currency',
    ccf_description:
      "It's the key coin of COCOBANK which is converted through various cryptocurrency in Direct exchange and C2C transactions. A CCF is worth a cent of USD. CCF enables quicker and safer purchases and transactions at COCOFX.",
    how_use_ccf: 'How to use CCF?',
    cocobank_wallet_transfer:
      'Transfer cryptocurrency assets from other exchanges to COCOBANK Wallet.',
    ccf_conversion:
    ...
    ccf_moved: 'The converted CCF transferred to COCOBANK Account',
    ...
    offline_convenient: 'Use COCOBANK’s services conveniently even offline!',
    how_wallets_accounts_different:
      "What's the difference between Wallet and Account?",
    same_means_storing_cryptocurrency:
      'Wallet and Account is the same meaning to keep cryptocurrency in COCOBANK. Namely, use Wallet to transact between exchanges and COCOBANK(external), use Account to transact in COCOBANK(internal).',
  },
  ...
  footer: {
    footer_msg: 'Try a coin-related account on COCOBANK!',
    footer_sub_msg: 'Use transaction, wallet and sevices through COCOBANK.',
    footer_sub_msg2: 'Tip',
  ...
  main_msg: {
    ...
    about_1_2_msg: 'As for the direct exchange it is available at COCOBANK.',
  ...
  pay_head_foot: {
    ...
    feed_back: 'feedback',
    warn_to_consumer:
      'Notification to customers: the owners of prepaid means of payment COCOBANK ⓒ Cocofx Pty Ltd does not require the approval of the Australian Financial Supervisory Authority. Please read carefully the terms and conditions.',
  },
  continue: 'continue',
  pay_home: {
    ...
    home_sec2_text1:
      'COCOBANK receives payments online, mobile and even e-mail.',
    home_sec2_text2:
      'Whether you sell it to anyone and anywhere, COCOBANK helps you make easier and safer payments.',
    home_sec2_online_pay: 'Online',
    home_sec2_online_text:
      "COCOBANK's easy-to-set payment button is  very convenient for payment, regular payment, donations, etc. COCOBANK Checkout makes it easier and faster for customers to pay.",
    home_sec2_online_more: 'See more online payment',
    home_sec2_voice_invoice: 'Email Invoice',
    home_sec2_voice_text:
      "Easy e-mail payment with a professional free invoice. Overseas customers are also available who don't have COCOBANK account.",
    ...
    home_sec5_h2: 'Why so many operators around the world trust COCOBANK?',
    home_sec5_sub_text:
    ...
    home_sec5_sub_text_2:
      'COCOBANK connects 25 currencies to more than 200 million customers in 200 markets around the world.',
    home_sec5_h3: 'Safety',
    home_sec5_h3_sub1:
    ...
    home_sec5_h31_sub1:
      'Anyone in the world can make a quick payment without entering information every time. Payments can be made via credit card, debit card, or COCOBANK in 26 currencies in 203 markets.',
    home_sec5_h31_more: 'See more about email invoices',
    home_sec5_h32: 'Fast',
    home_sec5_h32_sub1:
      'In most cases customer payment is immediately credited to your  COCOBANK account. Withdrawing, paying price or use freely in any place where COCOBANK payment is possible.',
    ...
    home_sec9_h2_2: 'This will COCOBANK together.',
  ...
  business: {
    ...
    available: 'Available',
    calculate_late: 'We show the most important CCF current assets.',
  ...
  pay_legal: {
    ...
    warn2:
      'COCOBANK the owners of prepaid means of payment ⓒ Cocofx Pty Ltd does not require the approval of the Australian Financial Supervisory Authority. We also encourage consumers (users) are carefully read these Terms and Conditions.',
    warn3:
  ...
  pay_main: {
    ...
    banner_text: 'COCOBANK is more secure',
    ...
    footer_4: 'feedback',
    footer_5:
      'Notification to customers: the owners of prepaid means of payment COCOBANK ⓒ Cocofx Pty Ltd does not require the approval of the Australian Financial Supervisory Authority.',
  ...
  account_transfer: {
    ...
    transfer_list_title: 'COCOBANK account transfer',
    ...
    account_number_list_3:
      'Presenting results The results of the results are the inquiry and merchant transfer results in COCOBANK. <br /> If you want to view the results of the transfer with other wallet, please check with [wallet Transfer] on the top.',
    account_number_list_3_1:
      'The current transfer result inquiry is a page for inquiries within COCOBANK and the transfer results of affiliate stores. <br/>If you would like to check the transfer result to your COCOBANK account, please check the [COCOBANK account transfer] at the top.',
    today: 'Day',
    one_week: '1 week',
    one_month: '1 month',
  ...
  cocobank_korea_head_office: 'COCOBANK Korea Head Office',
  cocobank_branch_office: 'COCOBANK Sinsa branch',
  address_head_office: 'Lotte World Tower, 300 Olympic-ro, Songpa-gu, Seoul',
  ...
  account_and_other_case_status: 'Check COCOBANK account and other case status',
  account_and_other_wallet: 'Check COCOBANK account and other case status',
  account_search: 'COCOBANK Account Inquiry',
  other_wallet_search: 'Other Wallet Transfer',
  error_remittance: 'Consent to return the error remittance in COCOBANK',
  transfer: 'Transfer',
  ...
  key_coin: "COCOBANK's key coin that connects cryptocurrency to real currency",
  limitation_info:
    'Guideline on limit restrictions for prevention of telecommunications financial fraud',
  limitation_info_1:
    'As a demand payment account is opened non-face-to-face, the withdrawal (transfer) limit through automated devices and the Internet is limited to {0} CCF per day.',
  limitation_info_2:
  ...
  new_subscription2_1:
    'Be sure to know before depositing! There are no fees if you transfer money from an account dedicated to COCOBANK to your account. Only',
  new_subscription2_2:
  ...
  cocobank_exclusive_account: 'COCOBANK exclusive account number',
  depositing_external_wallet:
    'When depositing COCOBANK from an external wallet',
  use: 'To use',
  ...
  event_banner: {
    clap:
      "Keep cryptocurrency in COCOBANK's <span class='color-common'>CLAP</span>.",
  ...
  clap: {
    ...
    detail_content2_1:
      'COCOBANK decided that Soft-wallet that store private keys in the cloud will be vulnerable to external hacking and other security issues. We propose a cryptocurrency wallet CLAP that compensates for this problem as a solution.',
    detail_content2_2:
    ...
    detail_content6_2:
      'If you need customer service, please visit COCOBANK with the CLAP.',
    detail_content6_3:
    ...
    detail_title_7: 'Note',
    detail_content7_1:
      'CLAP`s online service is provided by Ledger that is independent of COCOBANK. ',
    detail_content7_2:
    ...
    detail_content7_3:
      'Once again, we emphasize that the financial gains and losses that users earn from online services provided by "Ledger Live" or Ledger are irrelevant to COCOBANK.',
    ...
    detail_content9_1:
      'COCOBANK: 2F, 528, Eonju-ro, Gangnam-gu, Seoul, Republic of Korea',
    detail_content9_2:
