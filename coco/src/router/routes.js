...
import PayLayout from '@layouts/pay'
    ...
    children: [
      {
        ...
        component: () => lazyLoadView(import('@views/cocopay/pay-main')),
      },
      {
        name: 'ShopInfo',
        path: 'shop-info',
        component: () => lazyLoadView(import('@views/cocopay/shop-info')),
      },
      {
        name: 'Paymerchant',
        path: 'pay-merchant-list',
        component: () =>
          lazyLoadView(import('@views/cocopay/pay-merchant-list')),
      },
      {
        name: 'Paymerchantaccount',
        path: 'pay-merchant-account-list',
        component: () =>
          lazyLoadView(import('@views/cocopay/pay-merchant-account-list')),
      },
    ],
  },
  {
    ...
    children: [
      {
        name: 'Csnotice',
        path: 'cs-notice',
        component: () => lazyLoadView(import('@views/cocopay/customer-notice')),
      },
      {
        name: 'Csinquiry',
        path: 'cs-inquiry',
        component: () =>
          lazyLoadView(import('@views/cocopay/customer-inquiry')),
      },
      {
        name: 'Cshistory',
        path: 'cs-history',
        component: () =>
          lazyLoadView(import('@views/cocopay/customer-history')),
      },
      {
        name: 'Csdetail',
        path: 'cs-detail',
        component: () => lazyLoadView(import('@views/cocopay/customer-detail')),
      },
      {
        name: 'Csfaq',
        path: 'cs-faq',
        component: () => lazyLoadView(import('@views/cocopay/customer-faq')),
      },
    ],
  },
  {
    path: '/pay-certi-manage',
    component: PayLayout,
    redirect: 'Certikyc',
    children: [
      {
        ...
        component: () => lazyLoadView(import('@views/cocopay/certi-kyc')),
      },
      {
        name: 'Certiemail',
        path: 'certi-email',
        ...
        component: () => lazyLoadView(import('@views/cocopay/certi-email')),
      },
      {
        name: 'Certiotp',
        path: 'certi-otp',
        ...
        component: () => lazyLoadView(import('@views/cocopay/certi-otp')),
      },
      {
        name: 'Certiaddr',
        path: 'certi-addr',
        ...
        component: () => lazyLoadView(import('@views/cocopay/certi-addr')),
      },
      {
        name: 'Securityrating',
        ...
        component: () => lazyLoadView(import('@views/cocopay/security-rating')),
      },
    ],
  },
  {
