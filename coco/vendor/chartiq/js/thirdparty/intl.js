...
;(function(definition) {
  ...
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    throw new Error(
      'Only CommonJS, RequireJS, and <script> tags supported for intl.js.'
    )
  }
})(
  /* endRemoveIf(umd) */ function() {
      ...
      typeof global.Intl != 'undefined'
        ...
        : (function(Intl) {
            ...
            var // We use this a lot (and need it for proto-less objects)
              ...
              arrIndexOf =
                ...
                function(search) {
                  ...
                  for (
                    var i = arguments[1] || 0, max = t.length;
                    i < max;
                    i++
                  ) {
              ...
              fnBind =
                ...
                function(thisObj) {
                  ...
                  return function() {
                    fn.apply(
                      thisObj,
                      arrConcat.call(args, arrSlice.call(arguments))
                    )
                  }
                },
            ...
            ;(function() {
              ...
              expVariantDupes = RegExp(
                '^(?!x).*?-(' + variant + ')-(?:\\w{4,8}-(?!x-))*\\1\\b',
                'i'
              )

              // Match duplicate singletons in a language tag (except in private use)
              expSingletonDupes = RegExp(
                '^(?!x).*?-(' + singleton + ')-(?:\\w+-(?!x-))*\\1\\b',
                'i'
              )
	 ...
	 */
            function /* 6.2.3 */ CanonicalizeLanguageTag(locale) {
              ...
              for (var i = 1, max = parts.length; i < max; i++) {
                if (hop.call(redundantTags.subtags, parts[i]))
                  ...
                  if (
                    i === 1 &&
                    redundantTags.extLang[parts[1]][1] === parts[0]
                  ) {
            ...
            function /* 9.2.1 */ CanonicalizeLocaleList(locales) {
              ...
              while (k < len) {
                ...
                if (kPresent) {
                  ...
                  if (
                    kValue == null ||
                    (typeof kValue !== 'string' && typeof kValue !== 'object')
                  )
                  ...
                  if (!IsStructurallyValidLanguageTag(tag))
                    throw new RangeError(
                      "'" + tag + "' is not a structurally valid language tag"
                    )
            ...
            function /* 9.2.3 */ LookupMatcher(
              ...
              while (i < len && !availableLocale) {
                var // a. Let locale be the element of requestedLocales at 0-origined list
                  ...
                  noExtensionsLocale = String(locale).replace(
                    expUnicodeExSeq,
                    ''
                  ),
            ...
            function /* 9.2.5 */ ResolveLocale(
              ...
              while (i < len) {
                ...
                if (extensionSubtags !== undefined) {
                  ...
                  if (keyPos !== -1) {
                    ...
                    //	  than 2, then
                    if (
                      keyPos + 1 < extensionSubtagsLength &&
              ...
              if (supportedExtension.length > 2) {
                var // a. Let preExtension be the substring of foundLocale from position 0,
                  ...
                  foundLocale =
                    preExtension + supportedExtension + postExtension
              }
             ...
             * The following steps are taken:
             */
            function /* 9.2.6 */ LookupSupportedLocales(
              availableLocales,
              requestedLocales
            ) {
             ...
             */
            function /*9.2.7 */ BestFitSupportedLocales(
              availableLocales,
              requestedLocales
            ) {
             ...
             */
            function /*9.2.8 */ SupportedLocales(
              availableLocales,
              requestedLocales,
              options
            ) {
             ...
             */
            function /* 9.2.10 */ GetNumberOption(
              options,
              property,
              minimum,
              maximum,
             ...
             */
            function /*11.1.1.1 */ InitializeNumberFormat(
              numberFormat,
              locales,
              options
            ) {
              ...
              var // 14. Let dataLocale be the value of r.[[dataLocale]].
                ...
                s = GetOption(
                  ...
                  'style',
                  'string',
                  new List('decimal', 'percent', 'currency'),
                  'decimal'
                )
            ...
            function ToRawPrecision(x, minPrecision, maxPrecision) {
              ...
              // 3. Else
                ...
                m = m
                  .slice(0, m.indexOf('e') > -1 ? idx : m.length)
                  .replace('.', '')
              }
            ...
            function ToRawFixed(x, minInteger, minFraction, maxFraction) {
              ...
              if (exp) {
                ...
                m +=
                  arrJoin.call(Array(exp - (m.length - 1) + 1), '0') +
                  '.' +
             ...
             */
            function /* 12.1.1.1 */ InitializeDateTimeFormat(
              dateTimeFormat,
              locales,
              options
            ) {
            ...
            function ToDateTimeOptions(options, required, defaults) {
              ...
              //	  ToObject(options).
              options =
                options === undefined ? null : new Record(toObject(options))
              ...
              while (i < len) {
                ...
                for (var property in dateTimeComponents) {
                  ...
                  var // i. Let optionsProp be options.[[<property>]].
                    ...
                    formatProp = hop.call(format, property)
                      ? format[property]
                      : undefined
                  ...
                  if (internal['[[boundFormat]]'] === undefined) {
                    var // a. Let F be a Function object, with internal properties set as
                      ...
                      F = function() {
                        ...
                        //		operation (defined below) with arguments this and x.
                        var x = Number(
                          arguments.length === 0 ? Date.now() : arguments[0]
                        )
            ...
            function FormatDateTime(dateTimeFormat, x) {
              ...
              var internal = dateTimeFormat.__getInternalProperties(secret),
                ...
                localeData =
                  internals.DateTimeFormat['[[localeData]]'][dataLocale]
                    .calendars,
              ...
              'toLocaleStringIntl',
              {
                ...
                value: function() {
                  ...
                  if (
                    ...
                    throw new TypeError(
                      '`this` value must be a number for Number.prototype.toLocaleStringIntl()'
                    )
                  ...
                  return FormatNumber(
                    new NumberFormatConstructor(arguments[0], arguments[1]),
                    this
                  )
                },
              }
            ...
            /* 13.3.1 */ defineProperty(Date.prototype, 'toLocaleStringIntl', {
              ...
              value: function() {
                ...
                if (Object.prototype.toString.call(this) !== '[object Date]')
                  throw new TypeError(
                    '`this` value must be a Date instance for Date.prototype.toLocaleStringIntl()'
                  )
                ...
                var // 3. If locales is not provided, then let locales be undefined.
                  ...
                  dateTimeFormat = new DateTimeFormatConstructor(
                    locales,
                    options
                  )
