;(function(definition) {
  ...
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    throw new Error(
      'Only CommonJS, RequireJS, and <script> tags supported for quotes.js.'
    )
  }
})(function(_exports) {
   ...
   * @param {string} [params.source=Demo] The name of the requested data source
  ...
  CIQ.Quotes.Demo.fetch = function(params, cb) {
    ...
    var url = 'https://demoquotes.chartiq.com/' + params.symbol.toUpperCase()
