...
function accessibilityMode() {
  ...
  if (!isAndroid) {
    var myElement = document.getElementById('chartContainer')
...
function accessibilitySwipe(direction) {
  ...
  stxx.controls.crossX.style.left = barPixel + 'px'
  stxx.controls.crossY.style.top = pricePixel + 'px'
  stxx.crossYActualPos = pricePixel

  stxx.controls.crossX.style.display = ''
  stxx.controls.crossY.style.display = ''

  stxx.controls.floatDate.style.visibility = ''
