;(window.webpackJsonp = window.webpackJsonp || []).push([
  ['floating-toolbars'],
  {
    '0ZwQ': function(t, e, o) {
      ...
      function m() {
        if (!b) return window.innerHeight
        var t = y(),
          e = getComputedStyle(t),
    ...
    gmn6: function(t, e, o) {
      ...
      o.r(e),
        function(t) {
          ...
          var i = o('mrSG'),
            n = (o('P5fv'), o('nbsC'), o('bf9a'), o('YFKU'), o('0ZwQ')),
            r = o('b2d7'),
            s = o('7KDR'),
            a = o('5VQP'),
            l = o('mMWL'),
                ...
                (o.prototype._attachHandlers = function() {
                  ...
                  r.a.favoriteAdded.subscribe(this, this._onFavoriteAdded),
                    ...
                    this.onWidgetsReordered().subscribe(this, function(e, o) {
                      if (
                        (r.a.favoriteMoved.unsubscribe(t, t._onFavoriteMoved),
    ...
    tPkB: function(t, e, o) {
      ...
      ;(function(e, i) {
        var n = o('ogJP').notNull,
          ...
          f = v.isLineTool,
          b = o('PC8g').trackEvent,
          y = o('ytGH').MultipleLineWidthsProperty
        function w(t) {
        ...
        o('m/4m'),
          ...
          (w.prototype._createWidthsButton = function(t) {
            if (
              (t = t || this.selectedSources().filter(f)).length < 1 ||
              !y.canCreateForSources(t)
            )
              return !1
            this._lineWidthsProperty &&
            ...
            var e = t
              ...
              .filter(n)
            ;(this._lineWidthsProperty = new y(e)),
          ...
          (w.prototype._showWidthsButton = function() {
            ...
            y.canCreateForSources(t) && this._createWidthsButton(t)
          }),
          ...
          (w.prototype.showPropertiesOf = function(t, e) {
            ...
            if (
              ...
              for (var i = {}, n = o.length - 1; n >= 0; --n) {
                for (
                  var r = o[n], s = e, a = r.name.split('.'), l = 0;
                  l < a.length;
                  ++l
                )
                  s = s && s[a[l]]
                ...
                if ('function' != typeof d || d(s, e)) {
                  ...
                  if ('combobox' !== r.inputType) {
                    ...
                    this._floatingToolbar.addWidget(u[0], {
                      index: this._$templatesButton ? 1 : 0,
                    }),
                  ...
                  r.simple
                    ? r.comboboxOptions.forEach(m.bind(null, p))
                    : r.comboboxOptions.forEach(C.bind(null, p)),
                    r.propertyProxy &&
                      (s = r.propertyProxy(
                        e,
                    ...
                    s.subscribe(
                      this,
                      this._onPropertyChanged.bind(this, r.name, s)
                    ),
                    this._floatingToolbar.addGroupedWidget(
                      {
                        id: r.name,
        ...
        ;(w.prototype._defaultToolProperties = function() {
          return [
            ...
            },
            {
              ...
              comboboxOptions: [
                ...
                { value: u.Arrow, iconSvgCode: V },
                { value: w.LINE_EXTEND, iconSvgCode: z },
              ],
            ...
            },
            {
              ...
              comboboxOptions: [
                ...
                { value: w.LINE_EXTEND, iconSvgCode: A },
              ],
              propertyProxy: this.createLineEndPropertyProxy(
                'rightEnd',
                'extendRight'
          ...
          (w.prototype._trackContextAction = function(t) {
            b('GUI', 'Context action on drawings', t)
          }),
          (w.prototype._createToolExceptionCases = function() {
            return {
              LineToolRegressionTrend: [],
              LineToolGannSquare: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolFibTimeZone: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              ...
              LineToolFibCircles: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolFibChannel: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolFibSpeedResistanceArcs: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolFibRetracement: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolFibSpeedResistanceFan: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolTrendBasedFibTime: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolFibWedge: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolGannComplex: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolGannFixed: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolGannFan: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolPitchfan: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolPitchfork: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolSchiffPitchfork2: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolSchiffPitchfork: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolInsidePitchfork: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
              LineToolTrendBasedFibExtension: w.prototype._buttonsForGrouppedProperties(
                !0,
                !0
              ),
            }
