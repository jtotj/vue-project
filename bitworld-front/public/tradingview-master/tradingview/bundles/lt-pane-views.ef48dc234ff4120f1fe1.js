    ...
    GzSs: function(e, t, i) {
      ...
      inherit(h, l),
        ...
        (h.prototype._drawCloseButton = function(e, t, i) {
          ...
          CanvasEx.drawPoly(
            e,
            [{ x: t + o, y: i + l }, { x: a - o, y: s - l }],
            !0
          ),
            CanvasEx.drawPoly(
              e,
              [{ x: a - o, y: i + l }, { x: t + o, y: s - l }],
              !0
            ),
            this._adapter._blocked &&
              ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'),
    ...
    LMGK: function(e, t, i) {
      ...
      inherit(c, d),
        ...
        (c.prototype._drawCancelButton = function(e, t, i, r) {
          ...
          CanvasEx.drawPoly(
            e,
            [{ x: t + l, y: i + h }, { x: s - l, y: o - h }],
            !0
          ),
            CanvasEx.drawPoly(
              e,
              [{ x: s - l, y: i + h }, { x: t + l, y: o - h }],
              !0
            )
        }),
            ...
            if (((p.data = 0), i.push(p), 1 !== e.points.length)) {
              ...
              if (((f.data = 1), 2 !== e.points.length)) {
                ...
                ;(L = h(C, L)),
                  ...
                  (L = h(C, L)),
                  (C = o(1, R / (2 * y)))
                var B = (L = h(C, L)).y >= 0 ? new r(g.x, g.y) : new r(b.x, b.y)
                ;(B.data = 2), i.push(B)
      ...
      inherit(p, n),
        (p.prototype._updateImpl = function() {
          if (
            ...
            var e = this._source.points()[0]
            2 === this._source.points().length && (m = this._source.points()[1])
            var t = this._source.properties(),
