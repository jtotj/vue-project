  ...
  ['ds-property-pages'],
  {
            ...
            if (
              ...
              if (_.options)
                ...
                'text' === _.type
                  ...
                  : 'bool' === _.type &&
                    this.bindControl(new b(P, i.inputs[m], !0, this.model(), I))
              P.change(c), (n[_.id] = S)
            }
          }
    ...
    '11dv': function(e, t, i) {
      ...
      ;(function(t) {
        ...
        var o = i('04K5'),
          ...
          C = a.DisabledBinder,
          y = (a.CheckboxWVBinding,
          a.ToFloatTransformerWithDynamicDefaultValue),
        ...
        inherit(R, o),
          ...
          (R.prototype.prepareLayout = function() {
            ...
            if (t.enabled('chart_property_page_scales')) {
              ...
              var Y = $('<input type="checkbox">').change(function() {
                ...
                q = this.addLabeledRow(W, window.t('Scale Price Chart Only'), Y)
              $('<td>')
                .append(Y)
                .prependTo(q),
                this.bindControl(
          ...
          (R.prototype.addTimezoneEditorRow = function(e) {
            ...
            for (var n = '', a = 0; a < f.length; a++)
              n += '<option value="' + f[a].id + '">' + f[a].title + '</option>'
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function() {
          ...
          var C = $('<tbody>').appendTo(this._table),
            ...
            g = this.createColorPicker(),
            w = ((n = this.addLabeledRow(C, $.t('Background'), y)),
            $('<table>'))
          $('<td colspan="5">')
            .append(w)
            .appendTo(n)
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function(e, t, i) {
          ...
          h.appendTo(d),
            ...
            this.bindControl(
              new l(h, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')
            )
          var c = $("<td class='colorpicker-cell'>")
          c.appendTo(o)
          var b = p(c)
        ...
        (b.prototype.prepareLayout = function() {
          ...
          for (var p = 1; p <= 7; p++) {
            var b = 'hlevel' + p
            this.addLevelEditor(n, 'Level ' + p, this._linetool.properties()[b])
          }
          for (p = 1; p <= 7; p++) {
            b = 'vlevel' + p
            this.addLevelEditor(l, 'Level ' + p, this._linetool.properties()[b])
          }
    ...
    A3Hk: function(e, t, i) {
      ...
      function a() {
        ...
        return (
          $(
            '<option value="' + o.LeftToRight + '">' + $.t('Left') + '</option>'
          ).appendTo(e),
          $(
            '<option value="' +
              o.RightToLeft +
      ...
      inherit(h, o),
        (h.prototype.addLevelEditor = function(e, t, i) {
          ...
          h.appendTo(p),
            ...
            this.bindControl(
              new r(h, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')
            )
          var c = $("<td class='colorpicker-cell'>")
          c.appendTo(o)
          var b = d(c)
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function() {
          ...
          var h = $('<table cellspacing="0" cellpadding="2">').appendTo(
            ...
            c = ((p = this.addLabeledRow(h, $.t('Background'), c)),
      ...
      ;(function(e) {
        ...
        inherit(_, s),
          (_.prototype._addSessionEditor = function(e, t, i, o) {
            ...
            } else T.logError('Session editor adding FAILED: wrong input type.')
          }),
              ...
              if (
                ...
                if (s.options)
                  ...
                  ;(0 === s.min || s.min) && x.push(d(s.min)),
                    ...
                    this.bindControl(
                      new y(L, this._property.inputs[w], x, !1, this.model(), T)
                    ),
                    L.addClass('ticker'),
                    isFinite(s.step) &&
                      s.step > 0 &&
        ...
        (p.prototype.prepareLayout = function() {
          ...
          t.levels._childs)) {
            ...
            ;(L = $('<td>')).appendTo(h),
              ...
              this.bindControl(
                new l(b, p.color, !0, this.model(), 'Change Gann Line Color', 0)
              ),
              this.bindControl(
    ...
    XXYQ: function(e, t, i) {
      ...
      inherit(y, n),
        (y.prototype.prepareLayout = function() {
          ...
          y = [s(this._linetool.properties().profitLevel.value()), l(0), r(1e9)]
          this.bindControl(
            new p(
              c,
        ...
        (g.prototype.prepareLayout = function() {
          ...
          $('<td>')
            ...
            this.bindControl(
              new u(v, t.showPriceLabels, !0, this.model(), 'Show Price Labels')
            ),
            this.bindControl(
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function() {
          ...
          var p = $('<input type="checkbox">'),
            h = this.addLabeledRow(this._table, window.t('Counterclockwise'), p)
          $('<td>')
            .append(p)
            .prependTo(h),
            this.bindControl(
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function(e, t) {
          ...
          d.appendTo(l),
            d.css('width', '70px'),
            this.bindControl(
              new a(d, e.coeff, !1, this.model(), 'Change Pitchfork Line Coeff')
            )
      ...
      inherit(g, o),
        (g.prototype.prepareLayout = function() {
          ...
          var a = $('<tbody>').appendTo(this._table),
            r = ((n = this.addLabeledRow(a, $.t('Text'))),
