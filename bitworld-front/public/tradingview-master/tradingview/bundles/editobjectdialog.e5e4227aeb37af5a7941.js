        ...
        i('PVgW'),
          ...
          (h.prototype.show = function(e) {
            if (t.enabled('property_pages')) {
              ...
              var y = h.createStudyStrategyPropertyPage(
                  this._source,
                  this._model
                ),
              ...
              if ((g && !g.widget().is(':empty')) || m || y) {
                ...
                var P,
                  ...
                  j = $('<div class="properties-tabs tv-tabs"></div>').appendTo(
                    x
                  )
                if (
                  ((this._tabs = []),
                ...
                return (
                  m &&
                    'function' == typeof m.dialogPosition &&
                    (B = m.dialogPosition(B, D) || B),
