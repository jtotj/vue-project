  ...
  ['chart-widget-gui'],
  {
    ...
    sAH5: function(t, e, i) {
                  ...
                  : (this._el.classList.add('tempDisabled'),
                    ...
                    (this._disableTimeout = setTimeout(function() {
                      null !== t._el &&
                        ...
                        t._el.classList.toggle(c.disabled, t._disabled.value()))
                    }, 1e3))))
            }),
            ...
            (e.prototype._updateTitleMaxWidthWithButton = function() {
              if (
                ...
                if (
                  ...
                  this._allButtonsWidth = Object(o.ensureNotNull)(i).clientWidth
                }
      ...
      var it = i('z61+'),
        ...
        At = new Map([
          ['DelayToRealtime', new Map([['medium', Et], ['large', Vt]])],
          ['DelayNoRealtime', new Map([['medium', Et], ['large', Vt]])],
          ['TFEXDelayForGuest', new Map([['medium', Et], ['large', Vt]])],
          ['MOEXDelayForGuest', new Map([['medium', Et], ['large', Vt]])],
          ['EOD', new Map([['medium', Tt], ['large', xt]])],
          ['TickByTick', new Map([['medium', Lt], ['large', Ht]])],
          ['BATSToRealtime', new Map([['medium', Lt], ['large', Ht]])],
        ]),
        Ot = new Map([
        ...
        qt = (window.t('Create a free account'),
        window.t('Learn more'),
        (function(t) {
          function e(e, i, s) {
            var o =
              ...
              return Object(s.__awaiter)(this, void 0, void 0, function() {
                ...
                return Object(s.__generator)(this, function(s) {
                  switch (s.label) {
                    ...
                    case 2:
                      if (((o = s.sent()), t !== this._dataUpdatedMode.value()))
                        return [2]
              ...
              return Object(s.__awaiter)(this, void 0, void 0, function() {
                ...
                return Object(s.__generator)(this, function(s) {
                  switch (s.label) {
                    ...
                    case 1:
                      return (
                        s.trys.push([1, 3, , 4]), [4, this._model.description()]
                      )
                    case 2:
                      return (
                        ...
                        (u = r[a]),
                          ...
                          ('DelayToRealtime' !== u &&
                            ...
                            this._options.subscriptionFullInfo &&
                              ...
                              'DelayToRealtime' === u &&
                              e[u].push(
                                Rt.format({ description: '<b>' + o + '</b>' })
                              ),
                            null !== o &&
                              'DelayNoRealtime' === u &&
                              e[u].push(
                                It.format({ description: '<b>' + o + '</b>' })
                              ),
                            this._options.subscriptionFullInfo &&
        ...
        $t = new Map([
          ['high', new Map([['medium', Yt], ['large', Jt]])],
          ['low', new Map([['medium', Yt], ['large', Jt]])],
        ]),
        te = new Map([
          ['high', yt.dataProblemHigh],
          ['low', yt.dataProblemLow],
        ]),
        ee = new Map([['high', Qt], ['low', Qt]]),
        ie = new Map([
      ...
      var se = (function(t) {
        ...
        ue = new Map([
          [!0, new Map([['medium', ne], ['large', le]])],
          [!1, new Map([['medium', ''], ['large', '']])],
        ]),
        de = new Map([[!0, yt.invalidSymbol], [!1, null]]),
        he = new Map([[!0, ae], [!1, null]]),
        ce = new Map([[!0, ae], [!1, null]]),
        pe = new Map([
          [!0, Ct.colorsPalette['color-invalid-symbol']],
          [!1, null],
        ]),
        _e = new Map([[!0, [re]], [!1, null]]),
        be = new Map([[!0, null], [!1, null]]),
        me = (function() {
          function t(t) {
            ;(this._el = document.createElement('div')),
      ...
      var ge = (function() {
        ...
        De = new Map([
          ['market', new Map([['medium', ye], ['large', fe]])],
          ['pre_market', new Map([['medium', Ee], ['large', Ve]])],
          ['post_market', new Map([['medium', Ce], ['large', Me]])],
          ['out_of_session', new Map([['medium', we], ['large', we]])],
          ['holiday', new Map([['medium', Se], ['large', Se]])],
        ]),
        ze = new Map([
      ...
      var Ke = (function() {
        ...
        Ye = (new Map([
          [!0, new Map([['medium', Xe], ['large', Xe]])],
          [!1, new Map([['medium', ''], ['large', '']])],
        ]),
        new Map([[!0, yt.replayMode], [!1, null]]),
        new Map([[!0, Ze], [!1, null]]),
        new Map([[!0, Ze], [!1, null]]),
        new Map([[!0, Ct.colorsPalette['color-replay-mode']], [!1, null]]),
        new Map([[!0, [qe]], [!1, null]]),
        new Map([[!0, null], [!1, null]]),
        (function(t) {
          function e(e, i, s) {
          ...
          return (
            ...
            (e.prototype._updateIsInReplay = function(t) {
              this._isInReplayShow.setValue(t), this._updateForceStatusActive()
            }),
            e
          )
        })(Ke)),
      ...
      var _i = {
        ...
        bi = (Z.enabled('hide_legend_by_default'),
