  ...
  ['vendors'],
  {
              ...
              return (
                  ...
                  ;(c.style.cssText = 'background-color:rgba(1,1,1,.5)'),
                    ...
                    (e.cssHooks.borderColor = {
                      expand: function(e) {
                        var t = {}
                        return (
                          l(['Top', 'Right', 'Bottom', 'Left'], function(n, r) {
                            t['border' + r + 'Color'] = e
                          }),
                          t
                        )
                ...
                (function() {
                  ...
                  e.expr &&
                    ...
                    (e.expr.filters.animated = ((t = e.expr.filters.animated),
                    function(n) {
    ...
    P5fv: function(e, t) {
          ...
          p = {
            add: function() {
              if (c) {
                var e = c.length
                f(arguments),
                  r ? (a = c.length) : t && !0 !== t && ((o = e), d(t[0], t[1]))
              }
              return this
            },
            remove: function() {
          ...
          if (i.acceptData(e)) {
            ...
            if (c[l]) {
              if (t && (r = n ? c[l] : c[l].data)) {
                i.isArray(t) ||
                  (t = t in r || (t = i.camelCase(t)) in r ? [t] : t.split(' '))
      ...
      ;(i.event = {
        ...
        i.each({ mouseenter: 'mouseover', mouseleave: 'mouseout' }, function(
          e,
          t
        ) {
          i.event.special[e] = {
      ...
      ;(ie.optgroup = ie.option),
        ...
        i.fn.extend({
          ...
          wrapAll: function(e) {
            ...
            if (this[0]) {
              var t = i(e, this[0].ownerDocument)
                .eq(0)
                .clone(!0)
      ...
      i.ajaxSetup({
        ...
        i.ajaxTransport('script', function(e) {
          if (e.crossDomain) {
            var t,
              r =
                n.head || n.getElementsByTagName('head')[0] || n.documentElement
            return {
              send: function(o, i) {
    ...
    qFKp: function(e, t, n) {
      ...
      ;(r.isMobile = ((f = /Android/i.test(navigator.userAgent)),
