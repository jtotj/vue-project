  ...
  ['chart-bottom-toolbar'],
  {
    ...
    MfqI: function(e, t, n) {
        ...
        return (
          ((t = (function(t) {
            function n(e, n) {
              ...
              var i = (a._binding = Object(C.ensureDefined)(
                N.get(n.chartWidget)
              ))
            ...
            n.withModel(null, function() {
              ...
              a.onStatusChanged().subscribe(t, t._updateAvailableRanges),
                ...
                e
                  .model()
                  .onResetScales()
                  .subscribe(t, t._resetActiveInterval),
                a
                  .dataEvents()
                  .symbolResolved()
                  .subscribe(t, t._resetActiveInterval),
                a
                  .properties()
                  .extendedHours.subscribe(t, t._resetActiveInterval),
            ...
            (e.prototype.destroy = function() {
              ...
              t.withModel(null, function() {
                ...
                a.onStatusChanged().unsubscribe(e, e._updateAvailableRanges),
                  ...
                  a
                    .properties()
                    .extendedHours.unsubscribe(e, e._resetActiveInterval)
              }),
      ...
      function z(e) {
        var t,
          n = c(
            e.className,
            D.item,
            (((t = {})[D.isActive] = e.isActive),
            (t[D.isFirst] = e.isFirst),
            (t[D.isLast] = e.isLast),
            t)
          )
        return a.createElement(
            ...
            function t(t, n) {
              ...
              return (
                (a._handleClick = function() {
                  ...
                  Object(E.trackEvent)('GUI', 'Chart Bottom Toolbar', 'go to'),
                    Object(M.showGoToDateDialog)(e.model())
                }),
                Object(x.c)(n, { chartWidget: s.any.isRequired }),
                a
              )
      ...
      var Me,
        ...
        Ae = (((ge = {}).properties = !0),
        (ge.fullscreen = !0),
        (ge.preventPhoneLayout = !0),
        ge),
        Oe = (((be = {}).fullscreen = Number.MIN_SAFE_INTEGER),
        ...
        (be.adj = 4),
        be),
        je = ((Me = new Map()).set(Re, 'logarithm'),
      ...
      var De = (((ve = { dateRangeMode: 'hidden' }).timeZones = !0),
        (ve.fullscreen = !0),
                ...
                null === l._raf &&
                  (l._raf = requestAnimationFrame(function() {
                    var e,
                      ...
                      h = s.offsetWidth,
                      p =
                        !Boolean(s.textContent) || u - d - h <= 0
                          ? 'collapsed'
                          : 'expanded'
                    if (
                      (Object.assign(o, { dateRangeMode: p }), 'expanded' !== p)
                    ) {
                      for (
                        var m =
                            u -
                            Object(C.ensureNotNull)(l._rangeCollapsed)
                              .offsetWidth -
                            0,
                          g = 0,
                          b = 0,
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      'div',
                      {
                        className: c(
                          xe.dateRangeWrapper,
                          'collapsed' !== e.dateRangeMode && xe.collapsed
                        ),
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        'div',
                        {
                          className: c(
                            xe.dateRangeWrapper,
                            'expanded' !== e.dateRangeMode && xe.collapsed
                          ),
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    this.props.logScaleButtonEnabled &&
                      a.createElement(Re, { className: xe.item }),
                    this.props.autoScaleButtonEnabled &&
                      a.createElement(Ne, { className: xe.item }),
    ...
    l4ku: function(e, t, n) {
      ...
      function p(e) {
        ...
        return n
          ? i.a.createElement(
              'li',
              { className: o(h.item, h.loading) },
              i.a.createElement(c.Loader, { color: 'gray' })
            )
          : i.a.createElement(
              'li',
              {
              ...
              !w &&
                _ &&
                i.a.createElement(r.a, { className: h.shortcut, text: _ }),
