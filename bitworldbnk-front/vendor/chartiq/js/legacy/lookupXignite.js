;(function(definition) {
  ...
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    throw new Error(
      'Only CommonJS, RequireJS, and <script> tags supported for lookupXignite.js.'
    )
  }
})(function(_exports) {
  ...
  CIQ.SymbolLookupModule = {
    ...
    doSymbolLookup: function(type, keyword, maxResults, cb) {
      ...
      var body =
        't=' + encodeURIComponent(keyword) + '&m=' + parseInt(maxResults, 10)
      ...
      setTimeout(function() {
        ...
        CIQ.postAjax(url, body.length < 1800 ? null : body, function(
          status,
          response
        ) {
          ...
          for (var r = 1; r < results.length; r++) {
            ...
            if (!self.internalSubscribedExchanges[fields[headers.source]])
              continue
            self.fastLookupShareMap[fields[headers.symbol]] =
              fields[headers.name]
