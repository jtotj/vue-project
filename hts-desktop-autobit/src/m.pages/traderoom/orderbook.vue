            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $t('order_total') }}
<span>({{ fromPairs(constants.asset.asset_codes)[selected_asset].split('/')[0] }})</span></td>
...
export default {
    ...
    computed: {
        ...
        s_asset_info() {
            return this.asset_list[this.selected_asset];
        },
        current_tick() {
