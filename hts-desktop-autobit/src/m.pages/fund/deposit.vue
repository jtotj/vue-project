        ...
        <form @submit.prevent="submit">
            <table>
                ...
                <tbody v-if="c_pending_deposit">
                    ...
                    <tr>
                        <td colspan="2">
                            <span class="readonly" data-role="request_amount"><input type="text" readonly :value="`${php.number_format(c_pending_deposit.request_amount)} USDT`"></span>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
            ...
            <div class="total">
                ...
                <b v-else>{{ premiums['XRPKRW'] ? (((params.request_amount + '').length ? params.request_amount : 0) / premiums['XRPKRW']).toFixed(8) : $t('not_calculation') }}</b>{{ 'XRP' }}
            </div>
            ...
            <div class="able_info">
                <h4><em>{{ $t('wallet_address') }}</em><b style="font-size: 12px;">{{ 'rsjXos2GgPECLkt3B5w2Yu14BTZd2SCEmA' }}</b></h4>
