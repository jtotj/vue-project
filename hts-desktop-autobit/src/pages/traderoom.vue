                    ...
                    <div class="order_control">
                        ...
                        <div class="tab_cnt" data-tab="order">
                            <div :class="{ 'on': tab[0] === selected_tab }" v-for="tab in tabs" v-loading="(tab[0] != 'HISTORY' && trade_loading) || (tab[0] === 'HISTORY' && history_loading)">
                                ...
                                <dl>
                                    <dt v-if="trade_method === 'MARGIN'">{{ tab[1] }}{{ $t('amount') }}({{ fromPairs(constants.asset.asset_codes)[s_asset].split('/')[0] }})</dt>
                                ...
                                <dl>
                                    <dt v-if="trade_method === 'MARGIN'">{{ tab[1] }}{{ $t('price_symbol_defalt') }}</dt>
                                ...
                                <ul class="order_btn">
                                    ...
                                    <li><button type="button" @click.prevent="trade(true)" :class="[tab[0].toLowerCase() + 'Now']">{{ $t('market_price') }}{{ tab[1] }}</button></li>
                                </ul>
                            </template>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <template v-for="val in c_trade_list">
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{{ php.number_format(val.evaluated_estate) }} <span class="unit">USDT</span></strong>
                                        </td>
                                        <td>
                            ...
                            <tbody>
                                <template v-for="(val,idx) in c_trade_list">
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{{ php.number_format(0) }} <span class="unit">USDT</span></strong>
                                        </td>
                                        <td>
                                        ...
                                        <td>{{ php.number_format(val.holding_gain_loss) }}  <span class="unit">USDT</span></td>
