<template>
    <main>
            ...
            <div class="wrapper">
                <div class="main_price">
                    <div class="price-item" v-for="asset in ticker_assets">
                        ...
                        <strong>{{ php.number_format(premiums[asset]) }} <span>USDT</span></strong>
        ...
        <div class="app_area" style="display:none;">
            <div class="global_width">
                <h3 class="tit">{{ $t('index.brand_mobile_app_down') }}</h3>
        ...
        <div class="btm_bnr" style="display:none;">
            <div class="wrapper">
                <div class="txt">
...
<style scoped>
.guide { background-image: url(~assets/img/main_sl_back.png); }
.guide ul li:first-child { background-image: url(~assets/img/main_sl1.png) !important; }
.order_btn {display: table; width: 100%;}
.order_btn > li:first-child {padding-left: 0;}
.order_btn>li{height:40px;display:table-cell;position:relative}.order_btn>li>button.reset{background:#b0b0b0}
.order_btn>li>button{display:block;width:100%;height:100%;text-align:center;font-weight:700;font-size:13px;color:#fff}
.order_btn>li>button.buy,.order_control .order_btn>li>button.buyNow{background:#e95653}.main_price{display:flex;justify-content:space-between;align-items:center}
.price-item{box-shadow:0 2px 20px 0 rgba(0,0,0,.05);box-shadow:0 10px 38px -9px rgba(0,0,0,.13);transition:all .3s;width:200px;border-radius:3px;background:#fff;padding:15px 0 0 20px;margin-top:25px;box-sizing:border-box}
.price-item:hover{transform:translate3d(0,-10px,10px);box-shadow:0 10px 38px -9px rgba(0,0,0,.59)}
</style>
