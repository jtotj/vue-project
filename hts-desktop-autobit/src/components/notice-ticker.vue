<script>
import { fetchCocofxDocumentList, fetchDocumentList } from '@/api/xe/board'
...
<template>
  <!-- 공지사항 및 뉴스 -->
  <div class="notice-news-wrap" style="display:none">
    <!-- 공지사항 -->
      ...
      <el-carousel height="40px" direction="vertical" arrow="never">
        ...
        >
          <a :href="notice.link" target="_blank">
            <img src="~assets/img/icon-bell-notice.svg" alt="공지" />
            {{ notice.title }}
          </a>
        </el-carousel-item>
        <el-carousel-item
        ...
        >
          <img
            src="~assets/img/icon-bell-notice.svg"
            alt="공지"
          />공지사항이 없습니다.
        </el-carousel-item>
      </el-carousel>
